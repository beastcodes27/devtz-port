        ...
        <aside class="hidden lg:flex flex-col w-64 bg-white dark:bg-[#171E4A] border-r border-gray-200 dark:border-[#2E3A82] select-none transition-colors duration-300">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1.5 font-mono text-xs overflow-y-auto">
                ...
                <a href="{{ route('admin.users.index') }}" 
                   class="flex items-center gap-3 px-3.5 py-2.5 rounded-xl font-bold transition-all {{ request()->routeIs('admin.users.*') ? 'bg-[#F5FF67] text-[#1C2459] shadow-[0_0_15px_rgba(245,255,103,0.3)]' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-[#1C2459]' }}">
